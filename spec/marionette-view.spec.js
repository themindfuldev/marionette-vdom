...
describe('base view', function() {
  ...
  describe('constructing a view with default options', function() {
    beforeEach(function() {
      ...
      this.View = VDOMItemView.extend();
      this.ViewPresets   = VDOMItemView.extend({ options: this.presets });
      this.ViewPresetsFn = VDOMItemView.extend({ options: this.presetsStub });
    });
  ...
  describe('should expose its options in the constructor', function() {
    beforeEach(function() {
      this.options = {foo: 'bar'};
      this.view = new VDOMItemView(this.options);
    });
